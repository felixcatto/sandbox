  ...
  render() {
    ...
    return (
      <div className="btn-group" role="group">
        <button type="button" className={leftBtnClass} onClick={this.onLeftBtnClick}>Left</button>
        <button type="button" className={rightBtnClass} onClick={this.onRightBtnClick}>Right</button>
      </div>
    );
  }
}
